...
`$GSTACK_PROJECTS/$SLUG/designs/` (user config directory, not project files).
...
- `mkdir -p $GSTACK_PROJECTS/$SLUG/designs/...`
...
|----------------|-------------|-----------|-------|
| [screen name]  | $GSTACK_PROJECTS/$SLUG/designs/[folder]/[filename].png | [brief description] | [constraints from review] |
```
